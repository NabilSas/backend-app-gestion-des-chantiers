...
import com.ird.faa.service.admin.facade.LotEmployeAdminService;
...
@Service
public class LotAdminServiceImpl extends AbstractServiceImpl<Lot> implements LotAdminService {
    ...
    @Autowired
    private LotEmployeAdminService lotEmployeService;
    @Autowired
    private PaiementLotAdminService paiementLotService;
