...
@Service
public class EmployeMaitreouvrageServiceImpl extends AbstractServiceImpl<Employe> implements EmployeMaitreouvrageService {

@Autowired
private EmployeDao employeDao;

        @Autowired
        private PrimeMaitreouvrageService primeService ;
        @Autowired
