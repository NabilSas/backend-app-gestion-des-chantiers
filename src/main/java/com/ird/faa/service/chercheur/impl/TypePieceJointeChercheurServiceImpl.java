...
import com.ird.faa.service.chercheur.facade.TypePieceJointeChercheurService;
...
@Service
public class TypePieceJointeChercheurServiceImpl extends AbstractServiceImpl<TypePieceJointe> implements TypePieceJointeChercheurService {
...
public List<TypePieceJointe> findAll(){
    List<TypePieceJointe> result= new ArrayList();
...
typePieceJointes.forEach(e->typePieceJointeDao.save(e));
        ...
        public List<TypePieceJointe> findAllNonArchive(){
        String query = "SELECT o FROM TypePieceJointe o  WHERE o.archive != true AND o.visible = true";
        return entityManager.createQuery(query).getResultList();
        }

        public List<TypePieceJointe> findAllByOwner(){
        List<TypePieceJointe> result= new ArrayList();
        User currentUser = SecurityUtil.getCurrentUser();
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())){
        String query = "SELECT o FROM TypePieceJointe o  WHERE o.archive != true AND o.visible = false AND o.username = '"+ currentUser.getUsername()+"'";
