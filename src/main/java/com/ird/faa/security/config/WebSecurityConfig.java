...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/actuator/info").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/maitreouvrage/login").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/maitreouvrage/").hasAnyAuthority(AuthoritiesConstants.MAITREOUVRAGE);
