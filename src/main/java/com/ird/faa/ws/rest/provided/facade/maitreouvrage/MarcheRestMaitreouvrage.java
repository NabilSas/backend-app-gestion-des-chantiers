...
@RestController
@RequestMapping("api/maitreouvrage/marche")
public class MarcheRestMaitreouvrage {
...
private MarcheConverter marcheConverter;
    ...
    public List<MarcheVo> findByCriteria(@RequestBody MarcheVo marcheVo){
        ...
        return marcheService.deleteByEtatMarcheId(id);
            ...
            @PutMapping("/archiver/")
            public MarcheVo archiver(@RequestBody MarcheVo marcheVo){
                Marche marche = marcheService.archiver(marcheConverter.toItem(marcheVo));
                return marcheConverter.toVo(marche);
                }

            @PutMapping("/desarchiver/")
            public MarcheVo desarchiver(@RequestBody MarcheVo marcheVo){
                Marche marche = marcheService.desarchiver(marcheConverter.toItem(marcheVo));
                return marcheConverter.toVo(marche);}
            }
