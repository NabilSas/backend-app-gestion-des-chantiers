...
@RestController
@RequestMapping("api/maitreouvrage/etatCharge")
public class EtatChargeRestMaitreouvrage {
...
private EtatChargeConverter etatChargeConverter;
    ...
    public List<EtatChargeVo> findByCriteria(@RequestBody EtatChargeVo etatChargeVo){
        return etatChargeConverter.toVo(etatChargeService.findByCriteria(etatChargeVo));
            ...
            @PutMapping("/archiver/")
            public EtatChargeVo archiver(@RequestBody EtatChargeVo etatChargeVo){
                EtatCharge etatCharge = etatChargeService.archiver(etatChargeConverter.toItem(etatChargeVo));
                return etatChargeConverter.toVo(etatCharge);
                }

            @PutMapping("/desarchiver/")
            public EtatChargeVo desarchiver(@RequestBody EtatChargeVo etatChargeVo){
                EtatCharge etatCharge = etatChargeService.desarchiver(etatChargeConverter.toItem(etatChargeVo));
                return etatChargeConverter.toVo(etatCharge);}
            }
