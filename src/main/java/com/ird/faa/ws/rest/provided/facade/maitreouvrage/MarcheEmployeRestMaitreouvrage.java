...
@RestController
@RequestMapping("api/maitreouvrage/marcheEmploye")
public class MarcheEmployeRestMaitreouvrage {
...
private MarcheEmployeConverter marcheEmployeConverter;
    ...
    public List<MarcheEmployeVo> findByCriteria(@RequestBody MarcheEmployeVo marcheEmployeVo){
        ...
        return marcheEmployeService.deleteByEmployeId(id);
            ...
            @PutMapping("/archiver/")
            public MarcheEmployeVo archiver(@RequestBody MarcheEmployeVo marcheEmployeVo){
                MarcheEmploye marcheEmploye = marcheEmployeService.archiver(marcheEmployeConverter.toItem(marcheEmployeVo));
                return marcheEmployeConverter.toVo(marcheEmploye);
                }

            @PutMapping("/desarchiver/")
            public MarcheEmployeVo desarchiver(@RequestBody MarcheEmployeVo marcheEmployeVo){
                MarcheEmploye marcheEmploye = marcheEmployeService.desarchiver(marcheEmployeConverter.toItem(marcheEmployeVo));
                return marcheEmployeConverter.toVo(marcheEmploye);}
            }
