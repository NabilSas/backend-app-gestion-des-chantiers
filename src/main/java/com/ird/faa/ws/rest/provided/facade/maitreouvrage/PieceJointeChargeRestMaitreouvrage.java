...
import com.ird.faa.service.maitreouvrage.facade.PieceJointeChargeMaitreouvrageService;
...
@RestController
@RequestMapping("api/maitreouvrage/pieceJointeCharge")
public class PieceJointeChargeRestMaitreouvrage {

@Autowired
private PieceJointeChargeMaitreouvrageService pieceJointeChargeService;
...
private PieceJointeChargeConverter pieceJointeChargeConverter;
    ...
    public List<PieceJointeChargeVo> findByCriteria(@RequestBody PieceJointeChargeVo pieceJointeChargeVo){
        ...
        return pieceJointeChargeService.deleteByChargeId(id);
            ...
            @PutMapping("/archiver/")
            public PieceJointeChargeVo archiver(@RequestBody PieceJointeChargeVo pieceJointeChargeVo){
                PieceJointeCharge pieceJointeCharge = pieceJointeChargeService.archiver(pieceJointeChargeConverter.toItem(pieceJointeChargeVo));
                return pieceJointeChargeConverter.toVo(pieceJointeCharge);
                }

            @PutMapping("/desarchiver/")
            public PieceJointeChargeVo desarchiver(@RequestBody PieceJointeChargeVo pieceJointeChargeVo){
                PieceJointeCharge pieceJointeCharge = pieceJointeChargeService.desarchiver(pieceJointeChargeConverter.toItem(pieceJointeChargeVo));
                return pieceJointeChargeConverter.toVo(pieceJointeCharge);}
            }
